...
# backup github https://raw.githubusercontent.com/danielcaraway/data/master/covid_04022020.csv
...
try:
    ...
    dftable = pd.read_csv('https://raw.githubusercontent.com/danielcaraway/data/master/covid_04022020.csv')
    dftable.columns = ['Country,Other', 'TotalCases', 'NewCases', 'TotalDeaths', 'NewDeaths',
        'TotalRecovered', 'ActiveCases', 'Serious,Critical', 'TotPerM',
        'DeathsPerM']
